                    ...
                    <div className={styles.mainFirst}>
                        <div className={styles.rightMain}>
                            ...
                            <div className={styles.parag}>
                                <div className={styles.innerParag}> A brand of Rissland Marketing UG (limited liability) <br/>
                        ...
                        <div className={styles.leftMain}>
                            <div className={styles.leftImgInfo}>
                                <img className={styles.leftImg} src="./smatchedlogo.png" alt='The smatched logo' />
                            </div>
                        </div>
                    </div>
                </div>
